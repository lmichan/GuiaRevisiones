...
**Automatizadas y No automatizadas**, La automatización de las revisiones sistemáticas (RS) se refiere al uso de cualquier método que pretenda acelerar, asistir o reemplazar las tareas manuales de los revisores que requieren juicio humano con una solución basada en algoritmos, con el objetivo de obtener resultados comparables a los que pueden lograr los revisores humanos, se realiza mediante métodos de inteligencia artificial (IA) y tecnologías informáticas avanzadas para hacer más rápido el procedimiento y asegurar su reproducibilidad (https://link.springer.com/article/10.1186/s13643-024-02592-3).
...
| Sección de la revisión | Contenido que puedes esperar |
| ------------ | ------------ |
